...
import static com.x2iq.sds.utils.ParamUtils.getDateInYourFormat;
    ...
    public class DEService2Web implements SdsService, EuWebService {
        ...
        private static String START_DATE = getStartCalender();
        private static String END_DATE =getEndCalender();
        ...
        private static String  getStartCalender() {
            Calendar calendar = Calendar.getInstance();
            calendar.set(2013,01,01);
            return new SimpleDateFormat("MM/dd/yyyy").format(calendar.getTime());
        }
        private static String  getEndCalender() {
            Calendar calendar = Calendar.getInstance();
        ...
        @Override
        @Scheduled(fixedDelay = 99999999999L)
